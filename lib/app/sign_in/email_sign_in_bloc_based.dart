...
class _EmailSignInFormBlocBasedState extends State<EmailSignInFormBlocBased> {
  ...
  List<Widget> _buildChildren(EmailSigninModel model) {
    return [
      ...
      SizedBox(height: 8.0),
      FormSubmitButton(
        text: model.getPrimaryText,
        onPressed: model.getSubmittedEnabled ? _submit : null,
      ),
      SizedBox(height: 8.0),
      FlatButton(
        child: Text(model.getSecondaryText),
  ...
  TextField _buildPasswordTextField(EmailSigninModel model) {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: 'Password',
        errorText: model.getPasswordShowErrorText
  ...
  TextField _buildEmailTextField(EmailSigninModel model) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        errorText:
            model.getEmailShowErrorText ? model.invalidEmailErrorText : null,
        enabled: model.isLoading == false,
      ),
      autocorrect: false,
